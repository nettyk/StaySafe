...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission (MainActivity.this,
            ...
            heading.setText("StaySafe needs access to");
            ...
            declaratioText.setText("The app is solely developed by Lynnet Kyalo and all data related to this app is stored locally in your phone.");
